...
const NoNotes = ({ setAllNotes }) => {
    ...
    return (
        <div className='h-60 flex flex-col items-center justify-center'>
            <h3 className='text-sm font-bold text-gray-500'>No Notes Found</h3>
            <div className='flex flex-row flex-nowrap items-center justify-center'>
                <h3 className='text-3xl font-bold text-gray-500'>Add</h3>
                ...
                <h3 className='text-3xl font-bold text-gray-500'>Note</h3>
            </div>
        </div>
    )
};
